...
import 'package:myapptest/src/helper/course_model_consultation.dart';
...
class Notification_page extends StatelessWidget {
  ...
  Widget _courceInfo(BuildContext context, CourseModelConsultation model, Widget decoration,
      {Color? background}) {
    return Container(
        height: 170,
